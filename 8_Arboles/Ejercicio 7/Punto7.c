/*Construir un �rbol binario de b�squeda, donde el contenido de cada nodo sea un entero positivo,
y que permita las siguientes acciones:
a) Insertar nodos en el �rbol.
b) Saber si el �rbol est� vac�o.
c) Buscar un elemento en el �rbol.
d) Eliminar un nodo del �rbol.
*/
...
{
	int num;
	printf("\nDigite un n�mero entero positivo: ");
	scanf("%d", &num);
	insertar(&arbol, num);
}
...
{
	printf("\t\tMEN�.");
	printf("\n\t\t1.Insertar datos en el �rbol.\n\t\t2.Saber si el �rbol est� vac�o.");
	printf("\n\t\t3.Buscar un elemento en el �rbol.\n\t\t4.Eliminar un nodo del �rbol.\n\t\t5.Salir del men�");
	printf("\n\n\t\tDigite una opci�n: ");
}
