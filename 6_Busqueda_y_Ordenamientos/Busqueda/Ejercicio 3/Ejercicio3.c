...
Adem�s, escribir funciones para obtener:

a) el m�ximo valor almacenado en el vector
b) el m�nimo valor almacenado en el vector
c) la media de todos los valores
d) la semisuma (promedio entre el m�ximo y m�nimo).
*/
...
{
	int i;
	printf("\Digite el n�mero de elementos del vector (MAXIMO 10): ");
	scanf("%d", &vector);
...
void mostraResultados()
{
	printf("\nEl m�ximo valor almacenado en el vector es: %d", mayorElemento(vector));
	printf("\nEl m�nimo valor almacenado en el vector es: %d", menorElemento(vector));
	printf("\nLa media de todos los valores en el vector es: %d", mediaDeValores(vector));
	printf("\nLa semisuma (promedio entre el m�ximo y m�nimo) es: %d", obtenerPromedio(vector));
}
